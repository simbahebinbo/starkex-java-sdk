...
public class StarkCurve {
    ...
    public ECPublicKeyParameters createPublicKeyParams(BigInteger publicKey, BigInteger x, BigInteger y) {
        return new ECPublicKeyParameters(curve.decodePoint(publicKey.toByteArray()), new ECDomainParameters(curve, curve.createPoint(x, y), N));
    }
    ...
    public ECPublicKeyParameters createPublicKeyParams(BigInteger publicKey) {
        return new ECPublicKeyParameters(curve.decodePoint(publicKey.toByteArray()), new ECDomainParameters(curve, curve.createPoint(getGx(), getGy()), N));
    }
